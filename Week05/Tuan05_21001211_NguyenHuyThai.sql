...
-- 1. Liet ke danh sach tat ca cac mat hang
...
from
	Customers
where
	CompanyName like 'V%' and City = 'Lyon'
...
select
	...
	UnitPrice,
	UnitsInStock,
	UnitsInStock * UnitPrice as Total
from
	Products
order by Total desc
...
from
	Orders
where
	year(OrderDate) = 1996 and month(OrderDate) = 9
...
select
	...
	Customerid,
	EmployeeID,
	datepart(weekday, OrderDate) as WeekDayOfOrdate
from
	Orders
where
	year(OrderDate) = 1997 and
